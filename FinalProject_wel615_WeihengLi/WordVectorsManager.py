...
class WordVectorsManager(ResourceManager):
    def __init__(self, name=None, omit_non_english=False):
        super().__init__()

        self.omit_non_english = omit_non_english
        self.wv_filename = "{}.txt".format(name)
        self.parsed_filename = "{}.pickle".format(name)
    ...
    def write(self):
        ...
        # print("file at!!!!",_word_vector_file)
